...
class StatusPb : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:modules.common.StatusPb) */ {
 public:
  StatusPb();
  virtual ~StatusPb();
  ...
  ::modules::common::ErrorCode error_code() const;
  void set_error_code(::modules::common::ErrorCode value);

  // @@protoc_insertion_point(class_scope:modules.common.StatusPb)
 private:
...
inline ::modules::common::ErrorCode StatusPb::error_code() const {
...
inline void StatusPb::set_error_code(::modules::common::ErrorCode value) {
...
template <> struct is_proto_enum< ::modules::common::ErrorCode> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::modules::common::ErrorCode>() {
  return ::modules::common::ErrorCode_descriptor();
}

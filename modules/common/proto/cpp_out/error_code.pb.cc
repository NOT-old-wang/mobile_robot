...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n\020error_code.proto\022\016modules.common\"J\n\010St"
      "atusPb\0221\n\nerror_code\030\001 \001(\0162\031.modules.com"
      "mon.ErrorCode:\002OK\022\013\n\003msg\030\002 \001(\t*\312\007\n\tError"
      ...
      "RROR_MSG\020\234\030\022\035\n\030LOCALIZATION_ERROR_LIDAR\020"
      "\200\031\022\035\n\030LOCALIZATION_ERROR_INTEG\020\344\031\022\034\n\027LOC"
      "ALIZATION_ERROR_GNSS\020\310\032\022\025\n\020PERCEPTION_ER"
      "ROR\020\240\037\022\030\n\023PERCEPTION_ERROR_TF\020\241\037\022\035\n\030PERC"
      "EPTION_ERROR_PROCESS\020\242\037\022\025\n\020PERCEPTION_FA"
      "TAL\020\243\037\022\032\n\025PERCEPTION_ERROR_NONE\020\244\037\022\035\n\030PE"
      "RCEPTION_ERROR_UNKNOWN\020\245\037\022\025\n\020PREDICTION_"
      "ERROR\020\210\'\022\023\n\016PLANNING_ERROR\020\360.\022\035\n\030PLANNIN"
      "G_ERROR_NOT_READY\020\361.\022\025\n\020HDMAP_DATA_ERROR"
...
StatusPb::StatusPb()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:modules.common.StatusPb)
}
StatusPb::StatusPb(const StatusPb& from)
  ...
  // @@protoc_insertion_point(copy_constructor:modules.common.StatusPb)
}
...
StatusPb::~StatusPb() {
  // @@protoc_insertion_point(destructor:modules.common.StatusPb)
  SharedDtor();
}
...
void StatusPb::Clear() {
// @@protoc_insertion_point(message_clear_start:modules.common.StatusPb)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:modules.common.StatusPb)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // optional .modules.common.ErrorCode error_code = 1 [default = OK];
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::modules::common::ErrorCode_IsValid(value)) {
            set_error_code(static_cast< ::modules::common::ErrorCode >(value));
          } else {
...
success:
  // @@protoc_insertion_point(parse_success:modules.common.StatusPb)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:modules.common.StatusPb)
  return false;
#undef DO_
}
...
void StatusPb::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:modules.common.StatusPb)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:modules.common.StatusPb)
}

::google::protobuf::uint8* StatusPb::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  // @@protoc_insertion_point(serialize_to_array_start:modules.common.StatusPb)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:modules.common.StatusPb)
  return target;
}

size_t StatusPb::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:modules.common.StatusPb)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:modules.common.StatusPb)
  GOOGLE_DCHECK_NE(&from, this);
  const StatusPb* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const StatusPb>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:modules.common.StatusPb)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:modules.common.StatusPb)
    MergeFrom(*source);
  }
}

void StatusPb::MergeFrom(const StatusPb& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:modules.common.StatusPb)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:modules.common.StatusPb)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:modules.common.StatusPb)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::modules::common::ErrorCode StatusPb::error_code() const {
  // @@protoc_insertion_point(field_get:modules.common.StatusPb.error_code)
  return static_cast< ::modules::common::ErrorCode >(error_code_);
}
void StatusPb::set_error_code(::modules::common::ErrorCode value) {
  assert(::modules::common::ErrorCode_IsValid(value));
  set_has_error_code();
  error_code_ = value;
  // @@protoc_insertion_point(field_set:modules.common.StatusPb.error_code)
}
...
const ::std::string& StatusPb::msg() const {
  // @@protoc_insertion_point(field_get:modules.common.StatusPb.msg)
  return msg_.GetNoArena();
}
void StatusPb::set_msg(const ::std::string& value) {
  set_has_msg();
  msg_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:modules.common.StatusPb.msg)
}
#if LANG_CXX11
void StatusPb::set_msg(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:modules.common.StatusPb.msg)
}
#endif
void StatusPb::set_msg(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:modules.common.StatusPb.msg)
}
void StatusPb::set_msg(const char* value, size_t size) {
  set_has_msg();
  msg_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:modules.common.StatusPb.msg)
}
::std::string* StatusPb::mutable_msg() {
  set_has_msg();
  // @@protoc_insertion_point(field_mutable:modules.common.StatusPb.msg)
  return msg_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
::std::string* StatusPb::release_msg() {
  // @@protoc_insertion_point(field_release:modules.common.StatusPb.msg)
  clear_has_msg();
...
void StatusPb::set_allocated_msg(::std::string* msg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:modules.common.StatusPb.msg)
}
